...
# Other way: python3 get_papers.py data_folder output_file.csv list_of_sources.csv
...
if __name__ == "__main__":
    ...
    for k in range(1, len(list_papers)):
        ...
        if list_papers[k][3] in sourceTable_transpose[1]:
            ...
            list_papers[k].append(sourceTable_transpose[5][sourceTable_transpose[1].index(list_papers[k][3])])
